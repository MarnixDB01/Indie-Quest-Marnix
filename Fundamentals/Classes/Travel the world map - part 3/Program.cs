...
namespace Travel_the_world_map___part_3
{
    class Location
    {
        public string Name;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                //loops through the amount of neighbors and lists them off of the index from the currentLocation's neighbors list.
                ...
                //Welcome message display after new player destination input.
                currentLocation = locations[Convert.ToInt32(playerInput)];
